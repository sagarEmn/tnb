    ...
    <>
      ...
      >
        <div className={globalStyles["display-nav-location-center"]}>
          ...
          <div className={globalStyles["px14-line"]}>HOME {">"} GALLERY</div>
        </div>
      </div>
      <div className="container mx-auto px-2">
        <div className={globalStyles["padding-container"]}>
          <div className={globalStyles.galleryRow} data-aos="zoom-in">
            <img
          ...
          <div className={globalStyles.galleryRowCenter} data-aos="zoom-in">
            <img
